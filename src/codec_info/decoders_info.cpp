...
std::vector<std::tuple<std::string, AVCodecID>> DecodersInfo::GetAllDecoders(AVMediaType media_type)
{
...
std::vector<std::tuple<std::string, AVCodecID>> DecodersInfo::GetHwDecoders(AVMediaType media_type)
{
    std::vector<std::tuple<std::string, AVCodecID>> decoders;
...
std::vector<std::tuple<std::string, AVCodecID>> DecodersInfo::GetSwDecoders(AVMediaType media_type)
{
    std::vector<std::tuple<std::string, AVCodecID>> decoders;
